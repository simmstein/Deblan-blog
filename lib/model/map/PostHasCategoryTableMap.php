...
/**
 * This class defines the structure of the 'post_has_category' table.
 *
 *
 ...
 */
class PostHasCategoryTableMap extends TableMap {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.model.map.PostHasCategoryTableMap';
	...
	{
	  // attributes
		$this->setName('post_has_category');
		$this->setPhpName('PostHasCategory');
		$this->setClassname('PostHasCategory');
