...
class CommentTableMap extends TableMap {
    ...
    $this->addRelation('CommentRelatedByParentCommentId', 'Comment', RelationMap::MANY_TO_ONE, array('parent_comment_id' => 'id', ), null, 'CASCADE');
    $this->addRelation('CommentRelatedByParentCommentId', 'Comment', RelationMap::ONE_TO_MANY, array('id' => 'parent_comment_id', ), null, 'CASCADE');
	} // buildRelations()
