...
abstract class BasesfGuardUserProfile extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the linkedin field.
	 * @var        string
	 */
	protected $linkedin;

	/**
	 * The value for the blog field.
	 * @var        string
	 */
	protected $blog;
	...
	public function setFirstname($v)
	{
		...
		if ($this->firstname !== $v) {
			$this->firstname = $v;
			$this->modifiedColumns[] = sfGuardUserProfilePeer::FIRSTNAME;
		}
	...
	public function setTwitter($v)
	{
		...
		if ($this->twitter !== $v) {
			$this->twitter = $v;
			$this->modifiedColumns[] = sfGuardUserProfilePeer::TWITTER;
		}
	...
	public function setFacebook($v)
	{
		...
		if ($this->facebook !== $v) {
			$this->facebook = $v;
			$this->modifiedColumns[] = sfGuardUserProfilePeer::FACEBOOK;
		}
	...
	/**
	 * Set the value of [linkedin] column.
	 * 
	 * @param      string $v new value
	 * @return     sfGuardUserProfile The current object (for fluent API support)
	 */
	public function setLinkedin($v)
	{
		...
		if ($this->linkedin !== $v) {
			$this->linkedin = $v;
			$this->modifiedColumns[] = sfGuardUserProfilePeer::LINKEDIN;
		}
	...
	public function setBlog($v)
	{
		...
		if ($this->blog !== $v) {
			$this->blog = $v;
			$this->modifiedColumns[] = sfGuardUserProfilePeer::BLOG;
		}
	...
	public function setDescription($v)
	{
		...
		if ($this->description !== $v) {
			$this->description = $v;
			$this->modifiedColumns[] = sfGuardUserProfilePeer::DESCRIPTION;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->twitter = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
			$this->facebook = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
			$this->linkedin = ($row[$startcol + 7] !== null) ? (string) $row[$startcol + 7] : null;
			$this->blog = ($row[$startcol + 8] !== null) ? (string) $row[$startcol + 8] : null;
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[5] => $this->getTwitter(),
			$keys[6] => $this->getFacebook(),
			$keys[7] => $this->getLinkedin(),
			$keys[8] => $this->getBlog(),
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[5], $arr)) $this->setTwitter($arr[$keys[5]]);
		if (array_key_exists($keys[6], $arr)) $this->setFacebook($arr[$keys[6]]);
		if (array_key_exists($keys[7], $arr)) $this->setLinkedin($arr[$keys[7]]);
		if (array_key_exists($keys[8], $arr)) $this->setBlog($arr[$keys[8]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(sfGuardUserProfilePeer::FIRSTNAME)) $criteria->add(sfGuardUserProfilePeer::FIRSTNAME, $this->firstname);
		...
		if ($this->isColumnModified(sfGuardUserProfilePeer::TWITTER)) $criteria->add(sfGuardUserProfilePeer::TWITTER, $this->twitter);
		if ($this->isColumnModified(sfGuardUserProfilePeer::FACEBOOK)) $criteria->add(sfGuardUserProfilePeer::FACEBOOK, $this->facebook);
		if ($this->isColumnModified(sfGuardUserProfilePeer::LINKEDIN)) $criteria->add(sfGuardUserProfilePeer::LINKEDIN, $this->linkedin);
		if ($this->isColumnModified(sfGuardUserProfilePeer::BLOG)) $criteria->add(sfGuardUserProfilePeer::BLOG, $this->blog);
		if ($this->isColumnModified(sfGuardUserProfilePeer::WEBSITE)) $criteria->add(sfGuardUserProfilePeer::WEBSITE, $this->website);
		if ($this->isColumnModified(sfGuardUserProfilePeer::DESCRIPTION)) $criteria->add(sfGuardUserProfilePeer::DESCRIPTION, $this->description);
