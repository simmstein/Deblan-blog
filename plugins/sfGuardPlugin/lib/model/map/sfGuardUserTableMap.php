...
class sfGuardUserTableMap extends TableMap {
	...
	{
    $this->addRelation('sfGuardUserProfile', 'sfGuardUserProfile', RelationMap::ONE_TO_ONE, array('id' => 'user_id', ), 'CASCADE', null);
    $this->addRelation('Post', 'Post', RelationMap::ONE_TO_MANY, array('id' => 'user_id', ), null, 'CASCADE');
