...
abstract class BasesfAssetFolder extends BaseObject  implements Persistent {
	 ...
	 * related Assets from storage. If this sfAssetFolder is new, it will return
		...
		if ($this->collAssets === null) {
			if ($this->isNew()) {
			   $this->collAssets = array();
				...
				$this->collAssets = sfAssetPeer::doSelect($criteria, $con);
			}
		} else {
	 ...
	 * @throws     PropelException
	 */
	public function addAsset(sfAsset $l)
	{
		if ($this->collAssets === null) {
			$this->initAssets();
		}
